...
2. Click on **BermaroTheme**.<br /> → The plugin will open.
3. Click on **Files » resources » css » bermaro.min.css** in the directory tree.
...
2. Go to the **Stylesheet (BermaroTheme)** area.
...
**BermaroTheme** allows you to override the templates of **Ceres** with your own content. To do so, enter the code in the template and override the template. In the following, setting up the homepage is explained. Set up the other templates the same way.
